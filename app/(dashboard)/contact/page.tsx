      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                <Phone className="mr-2 h-5 w-5 text-violet-600" />
                Phone Support
              </h3>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                <Mail className="mr-2 h-5 w-5 text-violet-600" />
                Email Support
              </h3>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600">1234 Example Street, Suite 100</p>
              <p className="text-gray-600">Sample City, CA 90210</p>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
          <div className="p-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center">
              <HelpCircle className="mr-2 h-6 w-6 text-violet-600" />
              Get in Touch
            </h2>
